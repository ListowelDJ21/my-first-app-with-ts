...
//declaration retrieves the value of the input 
  ...
  return (
    <div className="columns has-background-black-ter">
      <div className="column has-background-danger-dark">
        <div className="field">
          <QRCode value={`SMS:${number}:${message}`} size={200} /> 
      ...
      <div className="column has-background-success-dark" >
        <div className="field">
          <QRCode value={`mailto:${mail} Subject=${subject} &body=${body}.`} size={200} />
...
export default Appwork; //exports objects, fuctions, variables from the module.